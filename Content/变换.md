...
- 离散余弦变换——计算离散余弦变换并了解它们的能量压缩特性。  
[Colab Link](https://colab.research.google.com/github/XxxuLimei/Signal_Processing_Toolbox_Python/blob/main/Content/Transforms/离散余弦变换/离散余弦变换.ipynb) | [Jupyter-Notebook File](Transforms/离散余弦变换/离散余弦变换.ipynb)   
- DCT用于语音信号压缩——利用离散余弦变换对语音信号进行压缩。  
[Colab Link](https://colab.research.google.com/github/XxxuLimei/Signal_Processing_Toolbox_Python/blob/main/Content/Transforms/DCT用于语音信号压缩/DCT用于语音信号压缩.ipynb) | [Jupyter-Notebook File](Transforms/DCT用于语音信号压缩/DCT用于语音信号压缩.ipynb)   
